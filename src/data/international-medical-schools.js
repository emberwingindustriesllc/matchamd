...
export const internationalMedicalSchools = {
  ...
  'Nepal': [
    { school: 'Tribhuvan University Institute of Medicine (IOM)', city: 'Kathmandu' },
    { school: 'B.P. Koirala Institute of Health Sciences (BPKIHS)', city: 'Dharan' },
    { school: 'Kathmandu University School of Medical Sciences (KUSMS)', city: 'Dhulikhel' },
    { school: 'Nepal Medical College (NMC)', city: 'Kathmandu' },
    { school: 'Manipal College of Medical Sciences (MCOMS)', city: 'Pokhara' },
    { school: 'Chitwan Medical College (CMC)', city: 'Bharatpur' },
    { school: 'Universal College of Medical Sciences (UCMS)', city: 'Bhairahawa' },
    { school: 'Nepalese Army Institute of Health Sciences (NAIHS)', city: 'Kathmandu' },
    { school: 'Patan Academy of Health Sciences (PAHS)', city: 'Lalitpur' },
    { school: 'National Medical College', city: 'Birgunj' },
    { school: 'KIST Medical College', city: 'Lalitpur' },
    { school: 'Gandaki Medical College', city: 'Pokhara' },
    { school: 'College of Medical Sciences (COMS)', city: 'Bharatpur' },
  ],
  'Dominican Republic': [
